...
alias pycacheclean='$(clean_in_folder __pycache__); $(clean_in_folder .pytest_cache)'
...
source /home/deven/.local/bin/virtualenvwrapper.sh
...
path+=('/home/deven/go/bin')
path+=('/home/deven/.android/android-studio/bin')
path+=('/home/deven/Android/Sdk/platform-tools')
path+=($SCALA_HOME"/bin")
path+=($HOME"/.poetry/bin")
path+=('/usr/lib/google-cloud-sdk/bin/')
export PATH
# source syntax highlighter
source /home/deven/.zsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh

# added by travis gem
[ -f /home/deven/.travis/travis.sh ] && source /home/deven/.travis/travis.sh
